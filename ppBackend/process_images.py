...
def threshold(nn_mask):
    ...
    colorToTurnToWhiteAsAnInteger = int(thresholdSectionForConfiguration['configforcolortoturntowhite'])
    # turns colorToTurnToWhiteAsAnInteger into white
    th, threshold_mask = cv2.threshold(nn_mask, colorToTurnToWhiteAsAnInteger, 255, cv2.THRESH_BINARY)
